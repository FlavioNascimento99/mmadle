...
const en = {
  ...
  "leaderboard.guestCta": "Sign in with an account and opt in to appear here.",
  "leaderboard.optIn.title": "Appear on the public ranking",
  "leaderboard.optIn.body": "Your username, score, wins and streaks become visible to everyone. You can hide again anytime.",
  "leaderboard.optIn.on": "Public",
  "leaderboard.optIn.off": "Hidden",
  "leaderboard.youRank": "You are #{rank} with {score} points.",
  "leaderboard.you": "you",
  "leaderboard.loading": "Loading the ranking…",
  "leaderboard.loadError": "Could not load the ranking",
  "leaderboard.optFailure": "Could not update your visibility",
  "leaderboard.empty": "No one is on the board yet — be the first!",
  "leaderboard.scoreNote": "Score = 12 − tries per solved daily game (min 1). Winning in fewer tries scores more.",
  "leaderboard.thRank": "Rank",
  "leaderboard.thPlayer": "Player",
  "leaderboard.thScore": "Score",
  "leaderboard.thWins": "Wins",
  "leaderboard.thRate": "Rate",
  "leaderboard.thStreak": "Streak",
  "leaderboard.thBest": "Best",
  "leaderboard.thAvgTries": "Avg tries",
  "pool.all": "Men & women",
  "pool.men": "Men only",
  ...
  "search.keepTyping": "Top matches — keep typing to narrow down.",
  ...
  "status.solvedToday": "solved today",
  "auth.signIn": "Sign in",
  "auth.join": "Join",
...
const ptBR: Dict = {
  ...
  "leaderboard.guestCta": "Entre com uma conta e opte por aparecer aqui.",
  "leaderboard.optIn.title": "Aparecer no ranking público",
  "leaderboard.optIn.body": "Seu nome de usuário, pontos, vitórias e sequências ficam visíveis para todos. Você pode se ocultar a qualquer momento.",
  "leaderboard.optIn.on": "Público",
  "leaderboard.optIn.off": "Oculto",
  "leaderboard.youRank": "Você está em #{rank} com {score} pontos.",
  "leaderboard.you": "você",
  "leaderboard.loading": "Carregando o ranking…",
  "leaderboard.loadError": "Não foi possível carregar o ranking",
  "leaderboard.optFailure": "Não foi possível atualizar sua visibilidade",
  "leaderboard.empty": "Ninguém no ranking ainda — seja o primeiro!",
  "leaderboard.scoreNote": "Pontos = 12 − tentativas por jogo diário acertado (mín. 1). Acertar em menos tentativas vale mais.",
  "leaderboard.thRank": "Pos",
  "leaderboard.thPlayer": "Jogador",
  "leaderboard.thScore": "Pontos",
  "leaderboard.thWins": "Vitórias",
  "leaderboard.thRate": "Taxa",
  "leaderboard.thStreak": "Seg",
  "leaderboard.thBest": "Recorde",
  "leaderboard.thAvgTries": "Méd. tent",
  ...
  "search.keepTyping": "Primeiros resultados — continue digitando para refinar.",
  ...
  "status.solvedToday": "resolveram hoje",
  "auth.signIn": "Entrar",
